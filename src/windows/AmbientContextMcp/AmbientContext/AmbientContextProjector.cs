...
public static class AmbientContextProjector
{
    ...
    public static IReadOnlyList<AmbientState> BuildStates(
    ...
    public static IReadOnlyList<AmbientOutboundEvent> BuildEvents(IReadOnlyList<AmbientEvent> events)
    {
