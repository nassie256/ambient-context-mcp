    ...
    public static IReadOnlyList<EventSchema> GetAll()
    {
        ...
        [
            ...
            Schema("session_locked", "medium",
                ...
                "Fires when the Windows session is locked. No payload.",
                Array.Empty<EventPayloadKey>()),

            Schema("session_unlocked", "medium",
                "Windows セッションがアンロックされた瞬間。Payload なし。",
                "Fires when the Windows session is unlocked. No payload.",
                Array.Empty<EventPayloadKey>()),
            ...
            Schema("power_setting_changed", "low",
                ...
                "Notification of a Windows power setting change (AC/DC source, monitor power, lid switch, etc).",
                ...
                Key("guid", "low", "Windows GUID 表記。", "Windows GUID.", "02731015-4510-4526-99e6-e5a17ebd1aea"),
